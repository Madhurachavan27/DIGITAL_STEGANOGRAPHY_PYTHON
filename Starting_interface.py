...
def open_text_steganography():
    # Add your code to open the image steganography window here
    subprocess.Popen(['python','C:/Users/madhura/OneDrive/Documents/DIGITAL STEGANOGRAPHY/txtstegno.py'])
    pass
...
def main():
    ...
    text_button = ttk.Button(root, text="  Text Steganography  ", command=open_text_steganography, style="Pink.TButton")
